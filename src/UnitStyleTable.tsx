          ...
          <table className="w-full min-w-[960px] border-collapse text-sm">
            <thead className="sticky top-0 z-10 bg-gray-50 [&_th]:text-xs [&_th]:font-semibold">
              <tr className="shadow-[inset_0_-1px_0_0_#e5e7eb] bg-gray-50 text-left text-gray-500">
                ...
                {showPropertyUnitColumn && <th className="px-2 py-2 font-semibold">Property Unit</th>}
                <th className="px-2 py-2 font-semibold">Property Notes</th>
                <th className="w-[104px] px-2 py-2 text-center font-semibold">Actions</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row, index) => (
                <tr key={index} className="border-b border-gray-100 text-gray-600 hover:bg-gray-50">
                  ...
                  {showPropertyUnitColumn && <td className="px-2 py-2">{row.propertyUnit ?? "-"}</td>}
