...
const ROWS: RegistrationRow[] = [
  ...
  { crfNumber: "CRF1335421", accountNumber: "B000964107", clientName: "Luka Doncic", status: "Pending", sellerName: "Fantine ABC" },
  { crfNumber: "CRF1340156", accountNumber: "B001072458", clientName: "Giannis Antetokounmpo", status: "Active", sellerName: "Thénardier QWE" },
  { crfNumber: "CRF1345789", accountNumber: "B001185632", clientName: "Kawhi Leonard", status: "Cancelled", sellerName: "Valjean XYZ" },
  { crfNumber: "CRF1350234", accountNumber: "B001298704", clientName: "Nikola Jokic", status: "Pending", sellerName: "Enjolras DEF" },
  { crfNumber: "CRF1355867", accountNumber: "B001407856", clientName: "Devin Booker", status: "Active", sellerName: "Cosette GHI" },
  { crfNumber: "CRF1360512", accountNumber: "B001516923", clientName: "Shai Gilgeous-Alexander", status: "Active", sellerName: "Gavroche JKL" },
  { crfNumber: "CRF1365743", accountNumber: "B001625174", clientName: "Trae Young", status: "Pending", sellerName: "Javert MNO" },
  { crfNumber: "CRF1370198", accountNumber: "B001734285", clientName: "Donovan Mitchell", status: "Active", sellerName: "Fantine PQR" },
  { crfNumber: "CRF1375621", accountNumber: "B001843396", clientName: "Paolo Banchero", status: "Active", sellerName: "Enjolras STU" },
  { crfNumber: "CRF1380456", accountNumber: "B001952507", clientName: "Victor Wembanyama", status: "Cancelled", sellerName: "Valjean VWX" },
  { crfNumber: "CRF1385789", accountNumber: "B002061618", clientName: "Zion Williamson", status: "Pending", sellerName: "Cosette YZA" },
  { crfNumber: "CRF1390234", accountNumber: "B002170729", clientName: "Tyler Herro", status: "Active", sellerName: "Gavroche BCD" },
  { crfNumber: "CRF1395867", accountNumber: "B002289830", clientName: "Chris Paul", status: "Active", sellerName: "Javert EFG" },
  { crfNumber: "CRF1400512", accountNumber: "B002398941", clientName: "Khris Middleton", status: "Pending", sellerName: "Fantine HIJ" },
  { crfNumber: "CRF1405743", accountNumber: "B002507052", clientName: "Scottie Barnes", status: "Active", sellerName: "Enjolras KLM" },
  { crfNumber: "CRF1410198", accountNumber: "B002616163", clientName: "Jalen Brunson", status: "Active", sellerName: "Valjean NOP" },
  { crfNumber: "CRF1415621", accountNumber: "B002725274", clientName: "Darius Garland", status: "Cancelled", sellerName: "Cosette QRS" },
  { crfNumber: "CRF1420456", accountNumber: "B002834385", clientName: "Anfernee Simons", status: "Active", sellerName: "Gavroche TUV" },
  { crfNumber: "CRF1425789", accountNumber: "B002943496", clientName: "Tyrese Maxey", status: "Pending", sellerName: "Javert WXY" },
  { crfNumber: "CRF1430234", accountNumber: "B003052507", clientName: "Lamelo Ball", status: "Active", sellerName: "Fantine ZAB" },
  { crfNumber: "CRF1435867", accountNumber: "B003161618", clientName: "Franz Wagner", status: "Active", sellerName: "Enjolras CDE" },
];
    ...
    <div className="flex w-full flex-col overflow-hidden rounded-xl border border-primary-500 shadow-[0_1px_2px_rgba(10,13,18,0.05)]">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-primary-50 px-5 py-3">
        <div className="flex flex-wrap items-center gap-3 text-sm">
          <span className="rounded-md bg-primary-900 px-2 py-1 text-xs font-semibold text-white">OPENS</span>
          <span className="text-gray-700">Jul 15, 2026 · 9:00 AM</span>
          <ArrowRightIcon className="h-4 w-4 text-gray-400" />
          <span className="rounded-md bg-primary-900 px-2 py-1 text-xs font-semibold text-white">CLOSES</span>
          <span className="text-gray-700">Jul 15, 2026 · 9:00 PM</span>
          <span className="h-4 w-px bg-primary-200" />
          <CalendarIcon className="h-4 w-4 text-primary-600" />
          <span className="text-gray-700">
            CRF valid until <strong className="font-semibold text-primary-600">Jul 15, 2026</strong>
          </span>
        </div>
...
export default function LotteryRegistrationList() {
  ...
  const filteredRows = ROWS.filter((row) => {
    if (filters.crfNumber && !row.crfNumber.toLowerCase().includes(filters.crfNumber.toLowerCase())) return false;
                  ...
                  <div key={idx} className="flex flex-col gap-1">
                    ...
                    {filter.kind === "text" && filter.label === "CRF Number" && (
                      <input
                        ...
                        onChange={(e) => setFilters({ ...filters, crfNumber: e.target.value })}
