      ...
      <div className="flex h-full w-full flex-col">
        <div className="flex shrink-0 flex-col gap-4 px-5 pt-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex flex-col gap-1">
              <h1 className="text-lg font-semibold text-gray-900">Unit Holding</h1>
        ...
        <div className="flex w-full flex-1 flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-[0_1px_2px_rgba(10,13,18,0.05)]">
          ...
          <table className="w-full min-w-[1040px] border-collapse text-sm">
            ...
            <tbody>
              {ROWS.map((row) => (
                <tr key={row.holdingId} className="border-b border-gray-100 text-gray-600 hover:bg-gray-50">
                  <td className="px-4 py-2">
                    <Checkbox size="sm" />
                  </td>
                  <td className="px-2 py-2 font-semibold text-gray-900">{row.holdingId}</td>
