...
const ROWS: RegularRow[] = [
  { contractNo: "HLD0327451", buildingUnit: "AST-00A-C-08018", clientName: "Ja Morant", netTcp: "1,235", primarySellerName: "Ja Morant", sellerRole: "-", sellerGroup: "LG_RMC29" },
  { contractNo: "HLD0327448", buildingUnit: "SAT-00D-P-B1207", clientName: "Damian Lillard", netTcp: "2,451", primarySellerName: "Damian Lillard", sellerRole: "-", sellerGroup: "LG_RMC189" },
  { contractNo: "HLD0327426", buildingUnit: "LMR-00E-C-02014", clientName: "Stephen Curry", netTcp: "3,678", primarySellerName: "Stephen Curry", sellerRole: "-", sellerGroup: "LG_RMC132" },
  { contractNo: "HLD0327412", buildingUnit: "ALR-00C-C-01007", clientName: "Kevin Durant", netTcp: "4,890", primarySellerName: "Kevin Durant", sellerRole: "-", sellerGroup: "LG_RMC6" },
  { contractNo: "HLD0327408", buildingUnit: "ARP-00K-C-04005", clientName: "Anthony Edwards", netTcp: "5,123", primarySellerName: "Anthony Edwards", sellerRole: "-", sellerGroup: "LG_RMC195" },
  { contractNo: "HLD0327395", buildingUnit: "AVB-00A-C-01001", clientName: "Jimmy Butler", netTcp: "6,245", primarySellerName: "Jimmy Butler", sellerRole: "-", sellerGroup: "LG_RMC195" },
  { contractNo: "HLD0327382", buildingUnit: "BRX-00F-C-03009", clientName: "Joel Embiid", netTcp: "7,890", primarySellerName: "Joel Embiid", sellerRole: "-", sellerGroup: "LG_RMC6" },
];
    ...
    >
      <div className="flex w-full flex-col gap-5 px-6 py-6">
        ...
        <p className="text-xs text-gray-500">
          <strong className="font-semibold">Note:</strong> All reservations prior to July 1, 2016 and released in IFCA
          (previous system) will not be displayed in commission ledger.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-gray-200 bg-white px-5 py-4 shadow-[0_1px_2px_rgba(10,13,18,0.05)]">
          <span className="text-sm text-gray-700">
            View Seller: <strong className="font-semibold text-gray-900">E000000000000000008729345</strong>
          </span>
          <div className="flex gap-2">
            {["Deduction", "Posted VAT", "Debit Advice"].map((label) => (
              <span key={label} className="rounded-md border border-primary-50 bg-blue-50 px-3 py-1.5 text-xs font-semibold text-primary-500">
                {label}
              </span>
            ))}
          </div>
                  ...
                  <td className="px-2 py-3">
                    <div className="flex items-center justify-end">
                      <button
                        ...
                        onClick={() => navigate({ screen: "regular-commission-details", itemId: row.contractNo })}
